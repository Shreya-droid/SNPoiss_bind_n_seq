...
class SNPMotifAnalysis:
    ...
    def count_snp_impact(self, max_bins, snp_position=20, kmer_size=6): #change k-mer
        affected = 0
        not_affected = 0
    ...
    def plot_results(self, increased_affected, increased_not_affected, decreased_affected, decreased_not_affected, output_filename='../motif_affect_NKX25/NKX25_motif_analysis_plot.png'):
        ...
        ax.bar(x - width/2, increased_counts, width, label='Increased rsID', color='red', edgecolor='black')
        ax.bar(x + width/2, decreased_counts, width, label='Decreased rsID', color='blue', edgecolor='black')
...
if __name__ == "__main__":
    ...
    parser.add_argument('--rsid_inc', default='../motif_affect_NKX25/NKX25increased_rsIDs.txt', help="Path to the file containing increased rsIDs.")
    parser.add_argument('--rsid_dec', default='../motif_affect_NKX25/NKX25decreased_rsIDs.txt', help="Path to the file containing decreased rsIDs.")
    parser.add_argument('--input_file', default='../bound_vs_unbound/R52_07_Vs_R52_08.csv', help="Path to the input SNP data CSV file. You can use any file from TF.")
    parser.add_argument('--increased_output', default='../motif_affect_NKX25/processed_increased_sequences.csv', help="Path to save processed increased SNP data.")
    parser.add_argument('--decreased_output', default='../motif_affect_NKX25/processed_decreased_sequences.csv', help="Path to save processed decreased SNP data.")
